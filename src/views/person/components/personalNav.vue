<template>
  <div class="personal-nav pull-left">
    <div class="nav nav-stacked text-left">
      ...
      <div class="item">
        <li><a href="#" @click="handleHome()" class="glyphicon glyphicon-tower"> 首页<i class="pull-right">></i></a></li>
        <li><a href="#" @click="handlePersonal()" class="glyphicon glyphicon-tower"> 我的课程<i class="pull-right">></i></a></li>
        <li><a href="#" @click="handleFavorite()" class="glyphicon glyphicon-heart"> 我的收藏<i class="pull-right">></i></a> </li>
        <li><a href="#" @click="handleSetting()" class="glyphicon glyphicon-cog"> 个人设置<i class="pull-right">></i></a></li>
        <li><a href="#" @click="handlePassword()" class="glyphicon glyphicon-cog"> 更改密码<i class="pull-right">></i></a></li>
        <li><a href="#" @click="handleLogout()" class="glyphicon glyphicon-log-out"> 退出<i class="pull-right">></i></a></li>
      </div>
    </div>
  </div>
</template>
...
<script>
  import { queryUserDetail } from '@/api/personalNav'
  import { queryTeacherDetail } from '@/api/personalNav'
  export default {
    name: 'personalNav',
    data() {
      return{

  ...
  <div class="personal-content pull-right">
    <div class="personal-cont">
      ...
      <div class="my-course">
        ...
        <div class="cont">
          <div class="col-lg-6" v-for="item in learningCourse" key="learningCourse">
            <div class="item">
              <div class="imgIco"><img src="../../../assets/img/asset-timg.png" width="60" height="28" alt=""></div>
              <div class="title"><span class="lab">继续学习</span> {{item.courseName}} <span class="status">{{item.courseStatus}}</span>
              </div>
              <div class="about"><span class="lab">正在学习</span> 使用对象 </div>
              <div class="time">开始日期: {{item.courseStartTime}}</div>
              <div class="rate">
                <li class="active"></li>
                <li></li>
                <li></li>
                <li></li>
                <span>1/4 已完成部分 <em>进度 {{item.courseProgessBar}}</em></span></div>
              <div class="parting"></div>
              <div class="butItem text-center"><a href="#" class="golearing">继续学习</a> <a href="#" class="classcom">课程详情</a></div>
            </div>
          </div>
          <div class="clearfix"></div>
          <!--分页栏-->
